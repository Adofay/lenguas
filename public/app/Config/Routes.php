...
$routes->get('lenguas2/(:num)', 'LexController::list2/$1');
$routes->post('actividad/agregar', 'LexController::agregaract');
$routes->post('eventos/agregar', 'LexController::agregarevent');
$routes->get('eventos/editar/(:num)/(:num)', 'LexController::editar/$1/$2');
$routes->get('eventos/delete/(:num)', 'LexController::delete/$1');
$routes->post('eventos/actualizar', 'LexController::actualizarevent');
